...
I say "largely" because the possibility for corrections and adaptions cannot be foreclosed.
...
1. Chunks consist of parquet files with related data, each representing one table.

1. New data (a.k.a. "hotblocks") are handled separately until a new chunk is ready.

1. Data is always redundant (on s3/r2, on more than one worker, etc.);
